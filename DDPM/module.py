...
class ContextUnet(nn.Module):
    def __init__(self, in_channels, n_feat=256, in_shape=(1,128,128,128)):
        ...
        self.to_vec = nn.Sequential(nn.AvgPool3d((32, 32, 32)), nn.GELU())
        ...
        self.up0 = nn.Sequential(
            nn.ConvTranspose3d(4 * n_feat, 2 * n_feat, (32,32,32), (32,32,32)),
